...
?>
		...
		<div id="pageajoutTel">
			...
			<div id="content">
				<div class="container">
					<div class="row">
						<form method="post" action="index.php?nav=VerifModifierTel">
                                                    <div class="col-md-12"> 
							<div class="col-md-4">
							...
							<div class="col-md-4">
								<p> <label for="" > Fonctions : </label></p>
									...
									<br><br>
                                                                    ...
                                                                    <input type="file" name="photoTel" id="photoTel" value="<?php echo $donnees[9] ?>" required>
							</div>
                                                    </div>
  								...
  								<input type="radio" name="editionLimite" id="editionLimite" value="Non" <?php
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="Prix" id="Prix" value="<?php echo $donnees[5] ?>" required >
                                                                <br><br>
                                                                <input type="submit" name="ModifTel" id="ModifTel" value="Modifier le telephone" onclick="return(confirm('Etes-vous sur de vouloir modifier ce produit ?'));">
                                                        </div>
                                                    </div>
						</form>					 	
					</div>
