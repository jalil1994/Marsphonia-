...
while ($i<$nbTel[0]) {
  ?>
    ...
    <tr>
      ...
      <td><a href="index.php?nav=VerifSupprimerTel&amp;IdTel=<?php echo($infosTel[$i][0]);?>" onclick="return(confirm('Etes-vous sûr de vouloir supprimer cet article ? '));"> supprimer </a> </td>
    </tr>
      <?php $i++;
  } 
  ?>
