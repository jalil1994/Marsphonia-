...
<!-- META : DESCRIPTION + KEYWORD : -->
	...
	<meta property="og:url" content="http://www.learn-english-83.com/plan%20du%20site.php">
				...
				<div class="container">
					<div class="row">
						<ul>
								...
								<li><a href="Offre de formation.php">Offre de formation</a></li>
									<ul>
										<li><a href="Atelier.php">Atelier</a></li>
										<li><a href="Cours individuel.php">Cours individuel</a></li>
										<li><a href="Formule mixte.php">Formule mixte</a></li>
									</ul>
